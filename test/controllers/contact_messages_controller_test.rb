...
class ContactMessagesControllerTest < ActionController::TestCase
  ...
  test "should create contact_message" do
    assert_difference('ContactMessage.count') do
      post :create, contact_message: { body: @contact_message.body, email: @contact_message.email, name: @contact_message.name, phone_number: @contact_message.phone_number }
    end
  ...
  test "should update contact_message" do
    patch :update, id: @contact_message, contact_message: { body: @contact_message.body, email: @contact_message.email, name: @contact_message.name, phone_number: @contact_message.phone_number }
    assert_redirected_to contact_message_path(assigns(:contact_message))
  end
